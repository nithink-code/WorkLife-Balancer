      ...
      if (res.status >= 200 && res.status < 300) {
        if (isLoginMode) {
          ...
          if (res.data.token) {
            ...
            console.log('✓ Token starts with:', res.data.token.substring(0, 30));
          } else {
          ...
          if (res.data.user) {
            ...
            console.log('[SignUp] User logged in, triggering timer restoration');
          ...
          console.log('✅ [SignUp] Auto-login after signup successful:', {
          ...
          if (loginRes.data.token) {
            ...
            console.log('💾 Token stored in localStorage, length:', loginRes.data.token.length);
          } else {
          ...
          if (loginRes.data.user) {
            ...
            // Trigger timer restoration event for this user
            console.log('[SignUp] User signed up and logged in, triggering timer restoration');
            window.dispatchEvent(new CustomEvent('userLoggedIn', {
  ...
  const handleSignOut = async () => {
    ...
    try {
      ...
      if (userId) {
        ...
        console.log('[SignUp] Cleared all user data on logout:', userId);
      }
